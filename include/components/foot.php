<?php
$pages_noback = ["complete_day_one.php", "assign_callsign.php", "test_results.php", "take_test.php", "view_test.php", "login.php", "index.php", "shifts_index.php", "shifts_index_AllTime.php", "shifts_index_PastMonth.php", "shifts_index_PastWeek.php", "verify_shifts.php"]; ?>
<div class="container">

    ...
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
        ...
        <ul class="navbar-nav px-3">
            <li class="nav-item text-nowrap">
                ...
                <span style="color: rgba(255, 255, 255, 0.5)" id="SteamName"><?php echo $_SESSION['callsign'] . " | " . $_SESSION["char_name"]; ?>&nbsp;
                    <img id="DisplayImg" style="height: 32px; width: 32px" src="<?php echo $_SESSION['av_icon'] ?>" />
                    |

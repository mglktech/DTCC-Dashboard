...
<div class="container border">
    ...
    <button class="btn bg-danger text-light mb-3" data-toggle="modal" data-target="#FireModal" <?php if ($rank >= $_SESSION["rank"] || $rank < 0) echo "disabled" ?>><i class="fas fa-gavel"></i> Fire Employee</button>
</div>

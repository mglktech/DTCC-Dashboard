...
function FormatCopyPasta($status_desc, $signed_by, $char_name, $additionalInfo)
{
    ...
    echo "Regards<br>" . fetchPlayerFormatted($signed_by) . "<br> (This message was autogenerated.)";
}
...
<div class="row">
    <div class="col">
        <h6 class="mb-3">
            <?php echo "<p class='text-danger'>This application was Denied by " . fetchPlayerFormatted($signed_by) . " for the following reasons:</p>" ?>
        </h6>
